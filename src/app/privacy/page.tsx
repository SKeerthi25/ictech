        ...
        <div className="prose prose-invert prose-blue max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              IC TECH LTD ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by IC TECH LTD.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-white">4. GDPR Data Protection Rights</h2>
            <p className="text-gray-300 leading-relaxed">
